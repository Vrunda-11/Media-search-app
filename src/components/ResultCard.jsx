...
const ResultCard = ({item}) => {
  ...
  return (
    <div className="group relative w-full rounded-2xl overflow-hidden mb-4 shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer">
        ...
        <a target='_blank' className='block w-full h-auto' href={item.url}>
        ...
        <div id='bottom' className='opacity-0 group-hover:opacity-100 flex justify-between gap-3 items-center w-full 
          px-4 py-4 absolute bottom-0 text-white bg-linear-to-t from-black/80 via-black/40 to-transparent transition-opacity duration-200 pointer-events-none'>
